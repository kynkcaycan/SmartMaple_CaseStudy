...
Veriler, API'den JSON formatında alınır ve her kamp alanı için gerekli özellikler doğrulandıktan sonra, veritabanına eklenir.

Bu ekleme işlemi sırasında, kamp alanı adresi de alınarak veritabanına kaydedilir. 

Veritabanı işlemleri SQLAlchemy session kullanılarak yapılır ve her sayfa tamamlandığında bir sonraki sayfaya geçilir. 

Hatalar ve API istek hataları loglanır. 
Bu süreç, tüm kamp alanları çekilene kadar devam eder.
 """
